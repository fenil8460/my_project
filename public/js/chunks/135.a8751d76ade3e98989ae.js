...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      sideImg: __webpack_require__(/*! @/assets/images/pages/staff.svg */ "./resources/js/src/assets/images/pages/staff.svg"),
      formsData: {
        type: ''
      },
      // validation rules
  ...
  computed: {
    ...
    imgUrl: function imgUrl() {
      ...
      if (this.formsData.type == 'staff') {
        ...
        this.sideImg = __webpack_require__(/*! @/assets/images/pages/doctor.svg */ "./resources/js/src/assets/images/pages/doctor.svg");
      } else if (this.formsData.type == 'admin') {
        this.sideImg = __webpack_require__(/*! @/assets/images/pages/admin.svg */ "./resources/js/src/assets/images/pages/admin.svg");
      }
      ...
      this.$refs.loginForm.validate().then(function (success) {
        if (success) {
          _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].login({
            ...
            console.log(userData); // useJwt.setToken(response.data.accessToken)
            // useJwt.setToken("58|MV74Xl6rhtfcezimBtknOlJCoAXJ3hgADKIw4BOb") //doctor
            // useJwt.setToken("60|r3rSqcUSGiLv5VTlhurnEkR7fpRbaEs4NSdcyAdb") //admin

            _auth_jwt_useJwt__WEBPACK_IMPORTED_MODULE_4__["default"].setToken("61|1xudcGfeS6UERqPd2V0heqXWJuQab0loUWAtN4y3");
            ...
            console.log(userData.role); // ? This is just for demo purpose. Don't think CASL is role based in this case, we used role in if condition just for ease
            ...
            _this.$router.push('doctorHome/ALL').then(function () {
              _this.$toast({
      ...
      _c(
        ...
        [
          ...
          _c(
            "b-col",
            {
              staticClass: "d-none d-lg-flex align-items-center p-3",
              attrs: { lg: "6" },
            },
            [
              _c(
                ...
                {
                  staticClass:
                    "w-60 d-lg-flex align-items-center justify-content-center px-3",
                },
                [
                  _c("b-img", {
          ...
          _c(
            "b-col",
            {
              staticClass: "d-flex align-items-center auth-bg px-5 p-lg-8",
              attrs: { lg: "6" },
            },
            [
              _c(
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c(
                        ...
                        { attrs: { pills: "" } },
                        [
                          _c("b-tab", { attrs: { title: "Yes", active: "" } }),
                          _vm._v(" "),
                          _c("b-tab", { attrs: { title: "No" } }),
                        ],
                        1
                      ),
                    ],
                    ...
                    [
                      _c(
                        ...
                        [
                          _c(
                            "b-tab",
                            { attrs: { title: "OTP", active: "" } },
                            [_c("b-card-text", [_c("h1", [_vm._v("jjjj")])])],
                            1
                          ),
                          _vm._v(" "),
                          _c(
                            ...
                            [_c("b-card-text", [_c("h1", [_vm._v("okk")])])],
                            1
                          ),
                        ],
                        1
...
/***/ "./resources/js/src/assets/images/pages/admin.svg":
/*!********************************************************!*\
  !*** ./resources/js/src/assets/images/pages/admin.svg ***!
  \********************************************************/
/*! no static exports found */
...
module.exports = "/images/_/_/_/_/VIDUR-New/resources/js/src/assets/images/pages/admin.svg";

/***/ }),

/***/ "./resources/js/src/assets/images/pages/doctor.svg":
/*!*********************************************************!*\
  !*** ./resources/js/src/assets/images/pages/doctor.svg ***!
  \*********************************************************/
/*! no static exports found */
...
module.exports = "/images/_/_/_/_/VIDUR-New/resources/js/src/assets/images/pages/doctor.svg";
