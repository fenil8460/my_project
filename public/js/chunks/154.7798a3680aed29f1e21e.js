...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    registerDoctor: function registerDoctor() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("/api/register", doctorFormData).then(function (res) {
        console.log(res);
    ...
    registerAdmin: function registerAdmin() {
      ...
      axios__WEBPACK_IMPORTED_MODULE_3___default.a.post("/api/register", adminFormData).then(function (res) {
        console.log(res);
                                  ...
                                  [
                                    ...
                                    _c("div", { staticClass: "form-group" }, [
                                      ...
                                      _c("input", {
                                        ...
                                        attrs: {
                                          type: "file",
                                          id: "profile_pic_staff",
                                          name: "profile_pic_staff",
                                          accept: "image/*",
                                        },
                                        on: {
                                          change: function ($event) {
                                ...
                                [
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.doctorData.email },
                                      on: {
                                        input: function ($event) {
                                          if ($event.target.composing) {
                                            return
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: {
                                        value:
                                          _vm.doctorData.password_confirmation,
                                      },
                                      on: {
                                        input: function ($event) {
                                          if ($event.target.composing) {
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.doctorData.phone },
                                      on: {
                                        input: function ($event) {
                                          if ($event.target.composing) {
                                            return
                                ...
                                [
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.adminData.email },
                                      on: {
                                        input: function ($event) {
                                          if ($event.target.composing) {
                                            return
                                      ...
                                      directives: [
                                        {
                                          ...
                                          rawName: "v-model",
                                          value:
                                            _vm.adminData.password_confirmation,
                                          expression:
                                  ...
                                  _c("div", { staticClass: "form-group" }, [
                                    ...
                                    _c("input", {
                                      ...
                                      domProps: { value: _vm.adminData.phone },
                                      on: {
                                        input: function ($event) {
                                          if ($event.target.composing) {
                                            return
                                  ...
                                  _c("input", {
                                    ...
                                    domProps: { value: _vm.adminData.category },
                                    on: {
                                      input: function ($event) {
                                        if ($event.target.composing) {
                                          return
