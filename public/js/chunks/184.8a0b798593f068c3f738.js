...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  data: function data() {
    return {
      ...
      appLogoImage: _themeConfig__WEBPACK_IMPORTED_MODULE_6__["$themeConfig"].app.appLogoImage,
      branches: ["B1", "B2", "B3", "B4", "B5"],
      //currently hardcoded, needs to be changed later
      designations: ["Junior Staff", "Intern", "Junior Technician", "Senior Technician", "On Call Technician", "Support Staff", "Operational Head", "Manager", "General Manager", "Clinical Manager", "Assistant Manager"],
      formData: {
        type: "staff"
      },
      // validation
  ...
  computed: {
    ...
    placeholderBranch: function placeholderBranch() {
      return this.selectedBranch ? this.selectedBranch : "Select a branch";
    },
    placeholderDesignation: function placeholderDesignation() {
      return this.selectedDesignation ? this.selectedDesignation : "Select a designation";
    }
  },
  methods: {
    ...
    setBranch: function setBranch(branch) {
      this.selectedBranch = branch;
    },
    setDesignation: function setDesignation(designation) {
                ...
                [
                  _c("b-card-title", { staticClass: "mb-1" }, [
                    _c("h2", { staticClass: "text-primary" }, [
                      _vm._v("Register to Vidur"),
                    ]),
                  ]),
                  _vm._v(" "),
                  _c("b-card-text", { staticClass: "mb-2" }, [
                    _vm._v(
                      "\n                    Please register to get access to our website.\n                "
                    ),
                  ]),
                  _vm._v(" "),
                  _c(
                                              ...
                                              return [
                                                ...
                                                _c(
                                                  ...
                                                  [
                                                    ...
                                                    _vm._v(
                                                      "A-Z, a-z, 0-9 & special character are\n                                    mandatory\n                                "
                                                    ),
                                                  ]
                                                ),
                                              ]
                                      ...
                                      [
                                        _c(
                                          "b-dropdown",
                                          {
                                            attrs: {
                                              id: "dropdown-2",
                                              text: _vm.placeholderDesignation,
                                              block: "",
                                              lazy: "",
                                              split: "",
                                              variant: "outline-primary",
                                              ...
                                              return _c(
                                                "b-dropdown-item",
                                                {
                                                  ...
                                                  attrs: {
                                                    active:
                                                      designation ===
                                                      _vm.selectedDesignation,
                                                  },
                                                  on: {
                                                    click: function ($event) {
                                                      return _vm.setDesignation(
                                                        designation
                                                      )
                                                    },
                                                  },
                                ...
                                _c(
                                  "b-form-group",
                                  {
                                    attrs: {
                                      ...
                                      "label-for": "register-profile-picture",
                                    },
                                  },
                                  [
                                    _c("b-form-file", {
                                    ...
                                    _c("small", { staticClass: "ml-1 mt-1" }, [
                                      ...
                                      _vm._v(
                                        "Max\n                                size 1 mb & only jpg, png format allowed\n                            "
                                      ),
                                    ]),
                                  ],
                                  1
